                                    ...
                                    <td class="py-4 px-6 border-b border-grey-light">
                                        <div class="mb-6">
                                            <div class="flex flex-col mb-4">
                                                <p class="mb-2 uppercase font-bold text-lg text-grey-darkest">Joined_at
                                                </p>
                                            ...
                                            <div class="flex flex-col mb-4">
                                                <p class="mb-2 uppercase font-bold text-lg text-grey-darkest">
                                                    {{ $followers->count() }}
                                                    Followers</p>
                                                @foreach ($followers as $follower)
                                                    <p class="py-2 px-3 text-grey-darkest"
                                                        id="followers{{ $loop->index }}">
                                                        {{ $follower->name }}
                                                    </p>
                                                @endforeach
                                            </div>
                            ...
                            @foreach ($tweets as $tweet)
                                <tr class="hover:bg-grey-lighter">
                                    <td class="py-4 px-6 border-b border-grey-light">
                                        ...
                                        <div class="flex">
                                            <a href="{{ route('tweet.userdata', $tweet->user->id) }}">
